...
// 2) the workspace directory is pro-client and the tests and stories directories are in web/src/tests.
...
const testIconPath = path.join(__filename, '..', '..', 'resources', 'MedelyLogo.png');
